...
After `0.1.x`: parallel work through Phases 2–9 as priority dictates. Highest-Eff unblocked candidates are Task 47 (exclude IConsole from coverage measurement, Eff:2.0), Tasks 14+15+35 (RPC error-shape widening + `Jason.encode!` rescue, Eff:1.75), and Task 27+28 (Finch 0.19→0.21, Eff:1.75).
