...
| 47 | Exclude generated `Cartouche.Contract.IConsole` from coverage measurement [D:1/B:1/U:3 → Eff:2.0] 🚀 | ✅ | Done 2026-05-02. Added `mix.exs` `test_coverage: [ignore_modules: [~r/^Elixir\.Cartouche\.Contract\./]]` to exclude generated bindings from headline coverage. Verification: `mix test.json --cover --quiet --output /tmp/cov.json` reports `coverage.total_percentage` 91.95; `jq -r ' .coverage.modules[].module ' /tmp/cov.json | rg Cartouche.Contract.IConsole` returns no matches; `mix test.json --quiet` still green. |
