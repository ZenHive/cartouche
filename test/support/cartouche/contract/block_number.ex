defmodule Cartouche.Contract.BlockNumber do
  ...
  @doc false
  @spec prepare_query(term(), term()) :: term()
  ...
  @doc false
  @spec encode_query_cool() :: term()
  def encode_query_cool do
    ABI.encode(query_cool_selector(), [])
  end

  @doc false
  @spec prepare_query_cool(term(), term()) :: term()
  ...
  @doc false
  @spec exec_vm_query_cool(term()) :: term()
  ...
  @doc false
  @spec encode_query_four() :: term()
  def encode_query_four do
    ABI.encode(query_four_selector(), [])
  end

  @doc false
  @spec prepare_query_four(term(), term()) :: term()
  ...
  @doc false
  @spec exec_vm_query_four(term()) :: term()
  ...
  @doc false
  @spec encode_query_three() :: term()
  def encode_query_three do
    ABI.encode(query_three_selector(), [])
  end

  @doc false
  @spec prepare_query_three(term(), term()) :: term()
  ...
  @doc false
  @spec encode_query_two() :: term()
  def encode_query_two do
    ABI.encode(query_two_selector(), [])
  end

  @doc false
  @spec prepare_query_two(term(), term()) :: term()
