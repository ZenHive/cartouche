defmodule Cartouche.Contract.BlockNumber do
  ...
  def build_trx_query(contract) do
    %Cartouche.Transaction.V2{destination: contract, data: encode_query()}
  end
  ...
  def build_trx_query_cool(contract) do
    %Cartouche.Transaction.V2{destination: contract, data: encode_query_cool()}
  end
  ...
  def build_trx_query_four(contract) do
    %Cartouche.Transaction.V2{destination: contract, data: encode_query_four()}
  end
  ...
  def build_trx_query_three(contract) do
    %Cartouche.Transaction.V2{destination: contract, data: encode_query_three()}
  end
  ...
  def build_trx_query_two(contract) do
    %Cartouche.Transaction.V2{destination: contract, data: encode_query_two()}
  end
