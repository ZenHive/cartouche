defmodule Cartouche.VM do
  ...
  defmodule Operations do
    ...
    @spec do_sign_extend(any(), any()) :: any()
    ...
    @spec extend_with_sign(any(), any(), any()) :: any()
  ...
  @spec handle_static_call_result(any(), any(), any(), any()) :: any()
  ...
  @spec pad_or_truncate_return(any(), any()) :: any()
  ...
  @spec do_returndatasize(any()) :: any()
  ...
  @spec do_calldataload(any(), any()) :: any()
  ...
  @spec do_calldatasize(any(), any()) :: any()
  ...
  @spec do_calldatacopy(any(), any()) :: any()
